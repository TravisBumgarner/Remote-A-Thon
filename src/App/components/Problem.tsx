...
const Problem = () => {
    return <PageWrapper>
        ...
        <Text>Are you experiencing a problem in your community in need of a solution? Fill out the form below and participants will be given the opportunity to find a solution.</Text>
        <GoogleForm
